import { PbxLeadFieldBitrixUseCase } from './pbx-lead-field-bitrix.use-case';
import {
    BxEntityFieldManageService,
    BxEntityFieldsInstallService,
} from '../../../shared';

describe('PbxLeadFieldBitrixUseCase', () => {
    let pbxService: { init: jest.Mock };
    let parseService: { getParsedData: jest.Mock };
    let useCase: PbxLeadFieldBitrixUseCase;
    ...
    beforeEach(() => {
        ...
        useCase = new PbxLeadFieldBitrixUseCase(
            pbxService as never,
