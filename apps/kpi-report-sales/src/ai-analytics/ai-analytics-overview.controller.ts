...
export class AiAnalyticsOverviewController {
    ...
    @ApiOperation({
        ...
        description:
            ...
            'список сбрасывает уровни к дефолту по стажу. Запись в ais ' +
            '(type = ai-analytics-settings) и сброс кэша overview/attention ' +
            'домена — следующий обзор пересчитается с новыми уровнями.',
    })
