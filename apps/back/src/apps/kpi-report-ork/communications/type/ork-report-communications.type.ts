...
export const OrkReportCommunicationItems = {
    [OrkFields.ork_event_action.items.ea_ork_plan.code as EnumOrkEventAction]: {
        //запланирован
        [OrkFields.ork_event_initiative.items.ei_ork_incoming
            .code as EnumOrkEventInitiative]: {
            //Входящий
            [OrkFields.event_communication.items.ec_ork_call
                .code as EnumOrkEventCommunication]: {
                //звонок
            ...
            [OrkFields.event_communication.items.ec_ork_face
                .code as EnumOrkEventCommunication]: {
                //выезд
            ...
            [OrkFields.event_communication.items.ec_ork_mail
                .code as EnumOrkEventCommunication]: {
                //письмо
            ...
            [OrkFields.event_communication.items.ec_ork_edo
                .code as EnumOrkEventCommunication]: {
                //эдо
            ...
            [OrkFields.event_communication.items.ec_ork_signal
                .code as EnumOrkEventCommunication]: {
                //СС
        ...
        [OrkFields.ork_event_initiative.items.ei_ork_outgoing
            .code as EnumOrkEventInitiative]: {
            //Исходящий
            [OrkFields.event_communication.items.ec_ork_call
                .code as EnumOrkEventCommunication]: {
