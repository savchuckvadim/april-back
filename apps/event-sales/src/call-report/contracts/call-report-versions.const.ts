 ...
 *
 * v2.3 — 25.09.2026 (Фаза 3, П6/П8): расшифровка уходит модели с метками
 * [mm:ss] по сегментам транскрипции, у возражений добавлены startSec/endSec
 * (таймкод цитаты) и reaction (первая реакция менеджера — ось стиля).
 * Вход и схема ответа изменились по существу — разрыв ряда обязателен.
 */
export const CALL_REPORT_PROMPT_VERSION = 'focus-v2.3-2026-09-25';
