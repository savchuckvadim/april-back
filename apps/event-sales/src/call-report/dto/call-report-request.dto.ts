...
export class ScanCallsDto {
    ...
    @ApiPropertyOptional({
        description:
            ...
            '(порог только отсекает, тип звонка не назначает). По умолчанию — ' +
            'минимум карты порогов портала: настройки AI-аналитики по типам, ' +
            'иначе прежняя настройка разбора, иначе 300 из реестра.',
        example: 300,
        type: Number,
        minimum: 1,
    })
