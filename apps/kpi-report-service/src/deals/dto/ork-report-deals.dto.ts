import { IBXCompany } from '@lib/bitrix';
import { IBXDeal } from '@lib/bitrix/domain/crm/deal/interface/bx-deal.interface';
import {
    IBXFile,
    IBXFileItemField,
} from '@lib/bitrix/domain/file/bx-file.interface';
