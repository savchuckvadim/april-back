...
import { DealActController } from './controllers/deal-act.controller';
...
@Module({
    ...
    exports: [SmartActQueueService],
})
export class SmartActModule {}
