...
export class PbxCompanyDto {
    @ValidateNested({
        message: 'op_client_type must be a valid EntityFormFieldDto',
    })
    @Type(() => EntityFormFieldDto)
    [PbxCompanyEnum.op_client_type]: EntityFormFieldDto;

    @ValidateNested({
        message: 'op_category must be a valid EntityFormFieldDto',
    })
    @Type(() => EntityFormFieldDto)
    ...
    @ValidateNested({
        message: 'op_source_select must be a valid EntityFormFieldDto',
    })
    @Type(() => EntityFormFieldDto)
    ...
    @ValidateNested({
        message: 'supply_information must be a valid EntityFormFieldDto',
    })
    @Type(() => EntityFormFieldDto)
    [PbxCompanyEnum.SINFORMATION]: EntityFormFieldDto;

    @ValidateNested({
        message: 'manager_op must be a valid EntityFormFieldDto',
    })
    @Type(() => EntityFormFieldDto)
    [PbxCompanyEnum.manager_op]: EntityFormFieldDto;

    @ValidateNested({
        message: 'manager_tmc must be a valid EntityFormFieldDto',
    })
    @Type(() => EntityFormFieldDto)
