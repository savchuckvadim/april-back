...
import { bigintConvertToNumber } from '@lib/shared';
...
export class OfferTemplateMapper {
    static toSummaryDto(entity: OfferTemplate): OfferTemplateSummaryDto {
        return {
            ...
            pages:
                entity.offerTemplatePages?.map(
                    p =>
                        new OfferTemplatePageDto({
                            ...p,
                            id: String(p.id),
    ...
    static toFullDto(entity: OfferTemplate): OfferTemplateDto {
        ...
        const fonts =
            entity.offerTemplateFonts?.map(
                f =>
                    new OfferTemplateFontDto({
                        ...f,
                        id: BigInt(f.id),
                        name: f.name,
                    }),
