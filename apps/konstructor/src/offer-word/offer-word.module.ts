import { WordTemplateModule } from '@app/konstructor/modules/offer-template/word';
...
import { LibreOfficeModule } from '@app/konstructor/modules/libre-office';
import { OfferRenderDataService } from './services/render-data-services/offer-render-data.service';
import { InnerDealModule } from '@app/konstructor/modules/inner-deal/inner-deal.module';
...
import { InvoiceTemplateModule } from '@app/konstructor/modules/invoice-template';
