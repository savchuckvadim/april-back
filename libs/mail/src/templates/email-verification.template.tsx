                    ...
                    <Container className="mx-auto my-10 max-w-[500px] rounded-lg bg-white p-8 shadow-lg">
                        <Section className="text-center">
                            ...
                            <Text
                                ...
                                style={{ fontFamily: 'Geist, Arial' }}
                            >
                                Привет, {user.name} {user.surname}! Мы получили
                                запрос на верификацию вашей почты.
                            </Text>
                            <Section className="mb-8 rounded-lg border border-blue-100 bg-blue-50 p-6">
                                <Text
                                    ...
                                    style={{ fontFamily: 'Geist, Arial' }}
                                >
                                    Нажмите на кнопку ниже, чтобы подтвердить
                                    ваш адрес электронной почты. Ссылка
                            ...
                            <Text
                                ...
                                style={{ fontFamily: 'Geist, Arial' }}
                            >
                                Если вы не запрашивали верификацию почты, просто
