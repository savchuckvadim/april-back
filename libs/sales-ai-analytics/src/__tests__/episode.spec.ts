...
describe('buildEpisodes: эпизоды сделки и три вида концов', () => {
    ...
    it('«Не Беспокоить» (семантика F, кода в списке отказов нет) — тоже отказ, без хвоста цензуры', () => {
        ...
        // Решение владельца 22.09.2026 (Фаза 3, П11/B11): «Не Беспокоить»
        // остаётся отказом по семантике F стадии и в AI_EPISODE_FAIL_STAGE_CODES
        // НЕ добавляется — список кодов отказа не расширяем; проверка ниже
        // закрепляет это.
