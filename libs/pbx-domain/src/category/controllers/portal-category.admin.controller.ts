...
export class PortalCategoryAdminController {
    ...
    @Post('bulk')
    async createCategoriesBulk(
        @Body() body: CreateManyBtxCategoriesDto,
    ): Promise<BtxCategoryResponseDto[]> {
        return this.categoryService.createMany(body.categories);
    }
