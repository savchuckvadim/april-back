...
import { Field, ListItem } from './types/install-field.type';
 ...
 * (BxTaskFieldsInstallService, {@link BxUserFieldsInstallService}).
 *
 ...
 *
 * Перенесён из apps/pbx-install/src/modules/shared/entity/field (старый
 * путь реэкспортирует отсюда) — либа общая для pbx-install и kpi-report-sales.
 */
