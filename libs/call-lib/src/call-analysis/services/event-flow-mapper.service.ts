...
import { EventSalesFlowDto } from '@lib/shared/event-sales/dto/event-sales-flow.dto';
import { PlanDto } from '@lib/shared/event-sales/dto/plan.dto';
import { ReportDto } from '@lib/shared/event-sales/dto/report.dto';
import { PresentationDto } from '@lib/shared/event-sales/dto/presentation.dto';
import { MinimalUserDto } from '@lib/shared/event-sales/dto/user.dto';
import {
...
import {
    EnumEventPlanCode,
    EventPlanCall,
} from '@lib/shared/event-sales/types/plan-types';
import {
    CallFlowExtractDto,
