...
import {
    CALL_REPORT_DEAL_CATEGORY_CODES,
    CALL_REPORT_DEAL_SELECT,
    callReportDealText,
    CallReportDealFamilyContext,
    CallReportDealLookupApi,
    CallReportDealMatch,
    CallReportDealRow,
} from './call-report-deal-lookup.types';

// Контракты, константы и текст-хелпер вынесены в .types (лимит файла);
// прежний путь импорта для потребителей сохраняется реэкспортом.
export * from './call-report-deal-lookup.types';
