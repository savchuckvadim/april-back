...
/** Стадии — как у presentation/xo-сделок: план → ожидание → исходы. */
export const ZPR_SMART_STAGES = [
    { code: 'zpr_plan', name: 'Запланирован', semantics: null, sort: 10 },
    { code: 'zpr_pending', name: 'Ожидание', semantics: null, sort: 20 },
    { code: 'zpr_success', name: 'Состоялся', semantics: 'S', sort: 30 },
    { code: 'zpr_noresult', name: 'Не состоялся', semantics: 'F', sort: 40 },
    { code: 'zpr_fail', name: 'Отменён', semantics: 'F', sort: 50 },
] as const;
