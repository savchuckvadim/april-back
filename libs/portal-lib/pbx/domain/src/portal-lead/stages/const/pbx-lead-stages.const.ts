...
const SALES_LEAD_STAGES = [
    ...
    },
    {
        ...
        //
        // ФАКТ СОПОСТАВЛЕНИЯ — переключатель страховки входа
        // (LeadIntakeRescueService): стадия сопоставлена → крон дожимает
        // ТОЛЬКО застрявших в ней; не сопоставлена → свежие лиды окна
        // создания в любой открытой стадии.
        code: 'lead_xo_queue',
        name: 'xo_queue',
        title: 'Очередь в ХО',
        color: '#5B8DEF',
