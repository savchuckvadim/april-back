...
import { createProviderEntityFromPrisma } from '@lib/portal-lib/konstructor/provider/lib/provider-entity.util';
import { createTemplateBaseEntityFromPrisma } from '@lib/portal-lib/konstructor/template-base/lib/template-base-entity.util';
