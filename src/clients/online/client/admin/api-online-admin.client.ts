...
@Injectable()
export class APIOnlineAdminClient {
    private readonly logger = new Logger(APIOnlineAdminClient.name);
    ...
    constructor(
        ...
        this.baseUrl = this.configService.get('API_ONLINE_ADMIN_URL') as string;
