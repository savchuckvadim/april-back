...
import { YandexStorageService } from 'src/core/yandex/yandex-storage.service';

@Injectable()
export class FileStorageCopyService {
    private readonly logger = new Logger(FileStorageCopyService.name);
