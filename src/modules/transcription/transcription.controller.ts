...
export class TranscriptionController {
    ...
    async startTranscription(@Body() dto: TranscriptionRequestDto): Promise<TranscriptionResponseDto> {
        try {
    ...
    async getTranscriptionResult(@Param('taskId') taskId: string): Promise<TranscriptionResponseDto> {
