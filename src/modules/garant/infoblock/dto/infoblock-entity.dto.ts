...
import { InfogroupEntityDto } from '../../infogroup';
 ...
 */
export class InfoblockEntityDto {
    constructor(infoblock: InfoblockEntity) {
        ...
        this.group = infoblock.group
            ? new InfogroupEntityDto(infoblock.group)
            : undefined;
        // this.parent = infoblock.parent ? new InfoblockEntityDto(infoblock.parent) : undefined;
        // this.relation = infoblock.relation ? new InfoblockEntityDto(infoblock.relation) : undefined;
        // this.related = infoblock.related ? new InfoblockEntityDto(infoblock.related) : undefined;
        this.excluded = infoblock.excluded
            ? new InfoblockEntityDto(infoblock.excluded)
            : undefined;
        this.packages = infoblock.packages
            ? infoblock.packages.map(pkg => new InfoblockEntityDto(pkg))
            : undefined;
        this.packageInfoblocks = infoblock.packageInfoblocks
            ? infoblock.packageInfoblocks.map(
                  pkg => new InfoblockEntityDto(pkg),
              )
            : undefined;
    }
