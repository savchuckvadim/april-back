...
} from '../dtos/create-offer-template-page.dto';
...
export class OfferTemplatePageController {
    ...
    async createOfferTemplatePage(
        ...
        const result = await this.offerTemplatePageService.create(
    ...
    async findOneWithRelations(
        ...
        return this.offerTemplatePageService.findWithRelations(
            BigInt(params.id),
        );
    }
    ...
    async setActivePage(
        ...
        return this.offerTemplatePageService.setActive(
            BigInt(params.id),
            is_active,
        );
    }
