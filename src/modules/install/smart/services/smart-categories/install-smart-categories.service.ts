...
import { InstallSmartCategoriesParams } from '@/modules/install/category/install-smart-template.types';
import { normalizeCode } from '@/modules/install/shared/utils/bitrix-category-stage.utils';
import { InstallCategorySyncService } from '@/modules/install/category/install-category-sync.service';
