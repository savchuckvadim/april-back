...
export class ComplectCommentService {
    ...
    public getComplectComment(dto: InitSupplyDto): string {
        ...
        const complectName = contractSpecification.items.find(item => item.code === ContractSpecificationCodeEnum.COMPLECT_NAME)
    ...
    getContractTypeNameComment(dto: InitSupplyDto): string {
        ...
        return contractTypeName ? RpaCommentHelper.getBoldString(contractTypeName) : ''
