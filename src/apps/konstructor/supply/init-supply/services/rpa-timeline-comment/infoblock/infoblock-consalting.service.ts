...
export class InfoblockConsaltingService {
    ...
    getInfoblockConsaltingComment(contractSpecification: ContractSpecificationDto): string {

        const infoblockConsalting = contractSpecification.items.find(item => item.code === ContractSpecificationCodeEnum.PK)
