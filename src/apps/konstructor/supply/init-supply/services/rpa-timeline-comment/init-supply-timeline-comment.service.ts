...
export class InitSupplyTimelineCommentService {
    ...
    public async getTimelineComment(
        ...
        const providerComment =
            await this.providerCommentService.getProviderComment(dto);
        if (providerComment) {
        ...
        COMPLECT
        */
        const complectComment =
            this.complectCommentService.getComplectComment(dto);
        if (complectComment) {
        ...
        CONSULTING
        */
        const infoblockConsaltingComment =
            this.infoblockConsaltingService.getInfoblockConsaltingComment(
        ...
        INFOBLOCKS
        */
        const infoblocksComment =
            this.infoblocksCommentService.getInfoblocksComment(dto);
        ...
        */
        const contractComment =
            this.contractCommentService.getContractComment(dto);
        if (contractComment) {
        ...
        TOTAL SUM
        */
        const totalSumComment =
            this.totalSumCommentService.getTotalSumComment(dto);
        if (totalSumComment) {
