...
export class ContractRqHeaderService {
    ...
    public getContractHeaderText(
        ...
        const providerCompanyDirectorNameCase = this.inflectName(
            providerCompanyDirectorName,
        );
        const providerCompanyDirectorPositionCase = this.inflectNoun(
            providerCompanyDirectorPosition,
        );
