...
import { DocumentFieldBooleanSelect, DocumentFieldBooleanSelectNames, DocumentFieldDescriptionMode, DocumentFieldDescriptionNames, DocumentFieldViewMode, DocumentFieldViewNames, DocumentInfoblocksItems, DocumentInfoblocksItemsNames, DocumentInfoblocksOptionItem, DocumentInfoblocksOptionSelectItem, OfferSettings, SETTING_ITEM } from "../type/offer-settings.type";
import { Transform, Type } from "class-transformer";

class DocumentInfoblocksOptionViewItemDto implements DocumentInfoblocksOptionItem {
    @IsNumber()
    id: number
    @IsString()
...
class DocumentInfoblocksOptionDescriptionItemDto implements DocumentInfoblocksOptionItem {
    @IsNumber()
    id: number
    @IsString()
...
class DocumentInfoblocksOptionBooleanItemDto implements DocumentInfoblocksOptionSelectItem {
    @IsNumber()
    id: number
    @IsString()
