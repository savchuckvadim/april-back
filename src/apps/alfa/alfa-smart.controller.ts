...
export class AlfaSmartController {
    ...
    async getSmartCategories(
        @Param('entityTypeId') entityTypeId: string,
        @Query('domain') domain: string,
    ) {
        return await this.testSmartService.getSmartCategories(
            domain,
            entityTypeId,
        );
    }
    ...
    async getSmartDataById(
        @Param('entityTypeId') entityTypeId: string,
        @Query('domain') domain: string,
    ) {
        return await this.testSmartService.getSmartDataById(
            domain,
            entityTypeId,
        );
    }
