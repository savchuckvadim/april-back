...
export function updateDealDataFromBitrixResponse(bitrixResponse: AlfaBxField[]): typeof dealData {
...
export function getBxFieldsIdsForSelect(data: typeof dealData): string[] {
...
export function getDealValues(deal: IBXDeal, fieldsTemplate: typeof dealData): DealValue[] {
