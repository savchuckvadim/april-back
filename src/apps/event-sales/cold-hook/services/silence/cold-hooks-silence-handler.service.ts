...
// @Injectable()
// export class ColdHooksSilenceHandlerService {
//     private readonly logger = new Logger(ColdHooksSilenceHandlerService.name);
...
//                     ) as IBXCompany;
//                     this.logger.log('currentCompany', currentCompany.ID ?? 'null');
